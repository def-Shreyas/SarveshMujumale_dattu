...
const aiQuotes = [
  ...
  "Machine learning helps identify permit patterns...",
  "Every permit tells a safety story, AI helps us read it...",
];
          ...
          <Card className="shadow-xl border-t-4 border-[#0B3D91]">
            <CardHeader className="text-center pb-6">
              ...
              <p className="text-gray-600 text-lg">
                Upload the `ptw&kpi.xlsx` file to generate your
