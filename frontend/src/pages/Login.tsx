        ...
        >
          ...
          >
            ...
            <div className="relative h-20">
              {" "}
              {/* Container to hold rotating tips */}
              ...
              <div className="text-sm text-gray-600 mt-2 ml-6 space-x-2">
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-3xl">
                    ...
                    <ScrollArea className="h-[60vh] p-4 border rounded-md">
                      ...
                      <p>
                        You agree to use DATTU only for lawful purposes related
                        to workplace safety, training, compliance, and analysis.
                        You must not misuse the platform, reverse-engineer the
                        code, attempt to bypass security controls, or interfere
                      ...
                      <p>
                        ...
                        of your login credentials. Any activity under your
                      ...
                      <p>
                        DATTU, its algorithms, AI models, workflows, and UI/UX
                        are the exclusive intellectual property of [Your Company
                        Name]. You receive a non-transferable, limited license
                      ...
                      <p>
                        You retain ownership of all files and data you upload
                        ("Customer Data"). By uploading data, you grant us a
                        restricted license to process it solely for:
                      </p>
                      ...
                      <p>
                        We do **not** use your data to train generalized models
                      ...
                      <p>
                        To the fullest extent permitted by law, DATTU and [Your
                        Company Name] shall not be liable for any loss of data,
                        business interruption, lost profits, or indirect
                        damages. You use the platform **at your own risk**.
                      </p>
                      ...
                      <p>
                        These Terms shall be governed under the jurisdiction of
                        [Your Jurisdiction, e.g., Maharashtra, India].
                      </p>
                      ...
                      <p>
                        ...
                        at{" "}
                        <a
                          href="mailto:info.dattu@gurumaulient.in"
                          className="text-blue-600 underline"
                        >
                          info.dattu@gurumaulient.in
                        </a>
                        .
                      </p>
                    </ScrollArea>
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-3xl">
                    <DialogHeader>
                      <DialogTitle>
                        Data Privacy Policy (DPA Summary)
                      </DialogTitle>
                      <DialogDescription>
                    ...
                    <ScrollArea className="h-[60vh] p-4 border rounded-md">
                      ...
                      <p>
                        You are the **Data Controller**. You own the data. We,
                        [Your Company Name], are the **Data Processor**. We
                      ...
                      <p>
                        We process data you provide, including: Employee names,
                        incident reports, audit forms, training records, and
                        uploaded files (Excel, CSVs). This data is stored
                      ...
                      <p>
                        To provide AI-generated reports (like in the "AI Vision
                        Report" module), we send a summarized, anonymized
                        version of your data to the Google Gemini API. Your raw
                        data files *never* leave our secure environment. Google
                        does not use your data for training their models.
                      </p>

                      <h3 className="font-bold text-lg mt-4">5. Your Rights</h3>
                      <p>
                        You have the right to access, amend, and delete your
                        data. Upon contract termination, all your data will be
                        permanently deleted from our systems within 30 days.
                      </p>

                      <h3 className="font-bold text-lg mt-4">6. Contact</h3>
                      <p>
                        For any data privacy questions, please contact our Data
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-3xl">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Our commitment to data protection, security, and
                        reliability.
                      </DialogDescription>
                    </DialogHeader>
                    <ScrollArea className="h-[60vh] p-4 border rounded-md">
                      ...
                      <ul className="list-disc pl-5 text-sm space-y-1 mt-2 text-gray-700">
                        ...
                        <li>
                          ✔ Zero data training without explicit customer consent
                        </li>
                      ...
                      <ul className="list-disc pl-5 text-sm space-y-1 mt-2 text-gray-700">
                        ...
                        <li>
                          Dedicated environments available for enterprise
                          clients.
                        </li>
